...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserLock'
        db.create_table(u'adminlock_userlock', (
        ...
        db.send_create_signal(u'adminlock', ['UserLock'])


    def backwards(self, orm):
        # Deleting model 'UserLock'
        db.delete_table(u'adminlock_userlock')


    models = {
        u'adminlock.userlock': {
            'Meta': {'object_name': 'UserLock'},
